...
metaget.getproduce.call( fid, {from: account}).then(function(value) {
  ...
  var str3 = web3.toAscii(value[3]);
  var span_element4 = document.getElementById("getval4");
  span_element4.innerHTML = str3;
...
metaget.getquality.call( lid,{from: account}).then(function(value) {
  ...
  var str1 = web3.toAscii(value[1]);
  var cspan_element2 = document.getElementById("cgetval9");
    cspan_element2.innerHTML = str1;


  var cspan_element3 = document.getElementById("cgetval10");
    cspan_element3.innerHTML = value[2].valueOf();

  var str3 = web3.toAscii(value[3]);
  var cspan_element4 = document.getElementById("cgetval11");
    cspan_element4.innerHTML = str3;
  
  var str4 = web3.toAscii(value[4]);
  var cspan_element5 = document.getElementById("cgetval12");
    cspan_element5.innerHTML = str4;
...
metaget.getproduce.call( fid,{from: account}).then(function(value) {
    ...
    var cstr0 = web3.toAscii(value[0]);  
    cspan_element1.innerHTML = cstr0;
  
    var cspan_element2 = document.getElementById("cgetval2");
  var cstr1 = web3.toAscii(value[1]);
    cspan_element2.innerHTML = cstr1;

  var cspan_element3 = document.getElementById("cgetval3");
  var cstr2 = web3.toAscii(value[2]);
  cspan_element3.innerHTML = cstr2;
    
  var cstr3 = web3.toAscii(value[3]);
  var cspan_element4 = document.getElementById("cgetval4");
  cspan_element4.innerHTML = cstr3;   
